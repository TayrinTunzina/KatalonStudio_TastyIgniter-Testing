...
WebUI.click(findTestObject('Object Repository/Page_Reservation Create - TastyIgniter/div_Table 11'))
...
WebUI.click(findTestObject('Object Repository/Page_Reservation Create - TastyIgniter/td_28'))
...
WebUI.click(findTestObject('Object Repository/Page_Reservation Create - TastyIgniter/div_- please select -'))

WebUI.click(findTestObject('Object Repository/Page_Reservation Create - TastyIgniter/div_Testrestaurant'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Reservation Create - TastyIgniter/select_DefaultTestrestaurantTestrestaurantT_3da4a3'), 
    '8', true)
